...
Приложение работает и на **Android TV**: появляется в лаунчере телевизора и запускается с пульта (навигация с пульта, распознавание кабельного подключения).

## Установка

<p align="center">
  <a href="https://github.com/dmitrystarosta/WhiteListCheck/releases/latest" target="_blank"><img src="docs/badges/get-it-on-github.png" alt="Скачать APK с GitHub" height="60"></a>&nbsp;&nbsp;<a href="https://www.rustore.ru/catalog/app/ru.netstatus.app" target="_blank"><img src="docs/badges/rustore.png" alt="Скачать из RuStore" height="60"></a>
</p>
