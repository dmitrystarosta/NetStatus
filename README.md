...
- **Android TV**: приложение появляется в лаунчере телевизора, полностью управляется с пульта (подсветка выбранного элемента) и распознаёт кабельное подключение.
...
- Подсказка при активном VPN, чтобы результат не вводил в заблуждение
- Всегда тёмная тема на Android TV (у многих ТВ нет системного тёмного режима)
